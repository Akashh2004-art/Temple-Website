...
const Home = () => {
  const [activeEventIndex, setActiveEventIndex] = useState(0);  // Fixed: Added activeEventIndex to state
  ...
  const pujaTimings: PujaTiming[] = [
    ...
    },
    {
      name: "Night Shayan",
      time: "8:30 PM",
      description: "Final prayers of the day"
    }
  ];
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Puja Timings - Better grid for mobile */}
  ...
  {/* Events Section - Modified for slider */}
  <section className="py-10 md:py-16 bg-gray-50">
    <div className="container mx-auto px-4">
      ...
      {/* Donations Section - Mobile optimized */}
      <section className="py-10 md:py-16 bg-gray-50">
        <div className="container mx-auto px-4">
